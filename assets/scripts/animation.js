...
$(function () { // wait for document ready
    ...
    new ScrollMagic.Scene({
        duration: 700,    // the scene should last for a scroll distance of 100px
        offset: 5400    // start this scene after scrolling for 50px
        })
        .setTween(TweenMax.to(".tela-escura-efeito", 1, {className: "+=tela-escura-efeito-hide"}))
        .addIndicators({name: "tween css class"}) // add indicators (requires plugin)
        .removeClassToggle(true)
        .addTo(controller);
